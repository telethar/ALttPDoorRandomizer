...
default_lw = {
    ...
    'Light Hype Fairy', 'Desert Healer Fairy', 'Fortune Teller (Light)', 'Lake Hylia Fortune Teller', 'Kings Grave', 'Tavern',
    'Chicken House', 'Aginahs Cave', 'Sahasrahlas Hut', 'Lake Hylia Shop', 'Capacity Upgrade', 'Blacksmiths Hut',
...
open_mandatory_connections = [('Sanctuary S&Q', 'Sanctuary'),
                              ...
                              ('Desert Ledge Rocks Mirror Spot', 'Desert Palace Entrance (North) Spot'),
                              ('Desert Ledge Mirror Spot', 'Desert Ledge'),
                              ('Mire To Desert Stairs Mirror Spot', 'Desert Palace Stairs'),
                              ('Checkerboard Ledge Mirror Spot', 'Desert Checkerboard Ledge'),
...
inverted_mandatory_connections = [('Sanctuary S&Q', 'Dark Sanctuary Hint'),
                                  ...
                                  ('East Death Mountain Mirror Spot (Bottom)', 'East Dark Death Mountain (Bottom)'),
                                  ('Mountain Exit Ledge Mirror Spot', 'Bumper Cave Ledge'),
                                  ('Mountain Entrance Mirror Spot', 'Bumper Cave Entrance'),
